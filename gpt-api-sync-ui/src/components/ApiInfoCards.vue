  ...
  <div class="grid md:grid-cols-2 gap-8 w-full">
    <Card>
      <CardHeader>
        ...
        <CardDescription>从 gpt-load 服务获取的分组列表</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <p v-else-if="gptLoadError" class="text-red-500">{{ gptLoadError }}</p>
        <p v-else>暂无数据</p>
      </CardContent>
    </Card>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>从 new-api 服务获取的渠道列表</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <p v-else-if="newApiError" class="text-red-500">{{ newApiError }}</p>
        <p v-else>暂无数据</p>
      </CardContent>
    </Card>
  </div>
